...
proc create_root_design { parentCell } {
  ...
  # Create instance: pynq_interrupts, and set properties
  set pynq_interrupts [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 pynq_interrupts ]

  # Create instance: rst_ps7_0_100M, and set properties
  set rst_ps7_0_100M [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_ps7_0_100M ]

  # Create instance: system_interrupts, and set properties
  set system_interrupts [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 system_interrupts ]
  set_property -dict [ list \
   CONFIG.NUM_PORTS {1} \
 ] $system_interrupts
...
connect_bd_intf_net -intf_net [get_bd_intf_nets processing_system7_0_M_AXI_GP0] [get_bd_intf_pins ila_1/SLOT_0_AXI] [get_bd_intf_pins processing_system7_0/M_AXI_GP0]
  ...
  connect_bd_net -net axi_intc_0_irq [get_bd_pins axi_intc_0/irq] [get_bd_pins ila_0/probe8] [get_bd_pins system_interrupts/In0]
  connect_bd_net -net axi_timer_0_generateout0 [get_bd_pins axi_timer_0/generateout0] [get_bd_pins ila_0/probe0]
  connect_bd_net -net axi_timer_0_generateout1 [get_bd_pins axi_timer_0/generateout1] [get_bd_pins ila_0/probe1]
  connect_bd_net -net axi_timer_0_interrupt [get_bd_pins axi_timer_0/interrupt] [get_bd_pins ila_0/probe3] [get_bd_pins pynq_interrupts/In0]
  connect_bd_net -net axi_timer_0_pwm0 [get_bd_pins axi_timer_0/pwm0] [get_bd_pins ila_0/probe2]
  connect_bd_net -net axi_timer_1_generateout0 [get_bd_pins axi_timer_1/generateout0] [get_bd_pins ila_0/probe4]
  connect_bd_net -net axi_timer_1_generateout1 [get_bd_pins axi_timer_1/generateout1] [get_bd_pins ila_0/probe5]
  connect_bd_net -net axi_timer_1_interrupt [get_bd_pins axi_timer_1/interrupt] [get_bd_pins ila_0/probe7] [get_bd_pins pynq_interrupts/In1]
  connect_bd_net -net axi_timer_1_pwm0 [get_bd_pins axi_timer_1/pwm0] [get_bd_pins ila_0/probe6]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins axi_timer_1/s_axi_aclk] [get_bd_pins ila_0/clk] [get_bd_pins ila_1/clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_timer_0/s_axi_aresetn] [get_bd_pins axi_timer_1/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins axi_intc_0/intr] [get_bd_pins pynq_interrupts/dout]
  connect_bd_net -net xlconcat_0_dout1 [get_bd_pins processing_system7_0/IRQ_F2P] [get_bd_pins system_interrupts/dout]
