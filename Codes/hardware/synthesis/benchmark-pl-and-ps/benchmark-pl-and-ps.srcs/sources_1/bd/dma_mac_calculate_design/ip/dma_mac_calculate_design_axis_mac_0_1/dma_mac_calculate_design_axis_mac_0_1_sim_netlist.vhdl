...
--               V:/benchmark-pl-and-ps.srcs/sources_1/bd/dma_mac_calculate_design/ip/dma_mac_calculate_design_axis_mac_0_1/dma_mac_calculate_design_axis_mac_0_1_sim_netlist.vhdl
...
entity dma_mac_calculate_design_axis_mac_0_1_axis_mac_v1_0_M_AXIS_DataOut is
  port (
    m_axis_dataout_tvalid : out STD_LOGIC;
    m_axis_dataout_tlast : out STD_LOGIC;
    m_axis_dataout_tdata : out STD_LOGIC_VECTOR ( 3 downto 0 );
    m_axis_dataout_aclk : in STD_LOGIC;
    m_axis_dataout_tready : in STD_LOGIC;
    m_axis_dataout_aresetn : in STD_LOGIC
  );
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of dma_mac_calculate_design_axis_mac_0_1_axis_mac_v1_0_M_AXIS_DataOut : entity is "axis_mac_v1_0_M_AXIS_DataOut";
end dma_mac_calculate_design_axis_mac_0_1_axis_mac_v1_0_M_AXIS_DataOut;

architecture STRUCTURE of dma_mac_calculate_design_axis_mac_0_1_axis_mac_v1_0_M_AXIS_DataOut is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity dma_mac_calculate_design_axis_mac_0_1_axis_mac_v1_0_S_AXIS_DataIn is
  port (
    mst_exec_state_reg_0 : out STD_LOGIC;
    s_axis_datain_tlast : in STD_LOGIC;
    s_axis_datain_aclk : in STD_LOGIC;
    s_axis_datain_tvalid : in STD_LOGIC;
    s_axis_datain_aresetn : in STD_LOGIC
  );
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of dma_mac_calculate_design_axis_mac_0_1_axis_mac_v1_0_S_AXIS_DataIn : entity is "axis_mac_v1_0_S_AXIS_DataIn";
end dma_mac_calculate_design_axis_mac_0_1_axis_mac_v1_0_S_AXIS_DataIn;

architecture STRUCTURE of dma_mac_calculate_design_axis_mac_0_1_axis_mac_v1_0_S_AXIS_DataIn is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity dma_mac_calculate_design_axis_mac_0_1_axis_mac_v1_0_S_AXI_INTR is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of dma_mac_calculate_design_axis_mac_0_1_axis_mac_v1_0_S_AXI_INTR : entity is "axis_mac_v1_0_S_AXI_INTR";
end dma_mac_calculate_design_axis_mac_0_1_axis_mac_v1_0_S_AXI_INTR;

architecture STRUCTURE of dma_mac_calculate_design_axis_mac_0_1_axis_mac_v1_0_S_AXI_INTR is
  ...
  attribute SOFT_HLUTNM of \axi_arready_i_1__0\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \axi_wready_i_1__0\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \gen_intr_reg[0].reg_global_intr_en[0]_i_2\ : label is "soft_lutpair11";
  ...
  attribute SOFT_HLUTNM of \intr_counter[0]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \intr_counter[1]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \intr_counter[2]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \intr_counter[3]_i_1\ : label is "soft_lutpair10";
begin
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity dma_mac_calculate_design_axis_mac_0_1_axis_mac_v1_0_S_AXI_PsControl is
  port (
    axi_wready_reg_0 : out STD_LOGIC;
    axi_awready_reg_0 : out STD_LOGIC;
    axi_arready_reg_0 : out STD_LOGIC;
    s_axi_pscontrol_bvalid : out STD_LOGIC;
    s_axi_pscontrol_rvalid : out STD_LOGIC;
    s_axi_pscontrol_rdata : out STD_LOGIC_VECTOR ( 31 downto 0 );
    s_axi_pscontrol_aclk : in STD_LOGIC;
    s_axi_pscontrol_aresetn : in STD_LOGIC;
    s_axi_pscontrol_awvalid : in STD_LOGIC;
    s_axi_pscontrol_wvalid : in STD_LOGIC;
    s_axi_pscontrol_bready : in STD_LOGIC;
    s_axi_pscontrol_arvalid : in STD_LOGIC;
    s_axi_pscontrol_rready : in STD_LOGIC;
    s_axi_pscontrol_araddr : in STD_LOGIC_VECTOR ( 1 downto 0 );
    s_axi_pscontrol_awaddr : in STD_LOGIC_VECTOR ( 1 downto 0 );
    s_axi_pscontrol_wdata : in STD_LOGIC_VECTOR ( 31 downto 0 );
    s_axi_pscontrol_wstrb : in STD_LOGIC_VECTOR ( 3 downto 0 )
  );
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of dma_mac_calculate_design_axis_mac_0_1_axis_mac_v1_0_S_AXI_PsControl : entity is "axis_mac_v1_0_S_AXI_PsControl";
end dma_mac_calculate_design_axis_mac_0_1_axis_mac_v1_0_S_AXI_PsControl;

architecture STRUCTURE of dma_mac_calculate_design_axis_mac_0_1_axis_mac_v1_0_S_AXI_PsControl is
  ...
  signal \^s_axi_pscontrol_bvalid\ : STD_LOGIC;
  signal \^s_axi_pscontrol_rvalid\ : STD_LOGIC;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity dma_mac_calculate_design_axis_mac_0_1_axis_mac_v1_0 is
  port (
    s_axi_pscontrol_wready : out STD_LOGIC;
    s_axi_pscontrol_awready : out STD_LOGIC;
    s_axi_pscontrol_arready : out STD_LOGIC;
    s_axi_pscontrol_rdata : out STD_LOGIC_VECTOR ( 31 downto 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of dma_mac_calculate_design_axis_mac_0_1_axis_mac_v1_0 : entity is "axis_mac_v1_0";
end dma_mac_calculate_design_axis_mac_0_1_axis_mac_v1_0;

architecture STRUCTURE of dma_mac_calculate_design_axis_mac_0_1_axis_mac_v1_0 is
begin
axis_mac_v1_0_M_AXIS_DataOut_inst: entity work.dma_mac_calculate_design_axis_mac_0_1_axis_mac_v1_0_M_AXIS_DataOut
     port map (
      m_axis_dataout_aclk => m_axis_dataout_aclk,
      m_axis_dataout_aresetn => m_axis_dataout_aresetn,
      m_axis_dataout_tdata(3 downto 0) => m_axis_dataout_tdata(3 downto 0),
...
axis_mac_v1_0_S_AXIS_DataIn_inst: entity work.dma_mac_calculate_design_axis_mac_0_1_axis_mac_v1_0_S_AXIS_DataIn
     port map (
...
axis_mac_v1_0_S_AXI_INTR_inst: entity work.dma_mac_calculate_design_axis_mac_0_1_axis_mac_v1_0_S_AXI_INTR
     port map (
...
axis_mac_v1_0_S_AXI_PsControl_inst: entity work.dma_mac_calculate_design_axis_mac_0_1_axis_mac_v1_0_S_AXI_PsControl
     port map (
      ...
      s_axi_pscontrol_araddr(1 downto 0) => s_axi_pscontrol_araddr(1 downto 0),
      s_axi_pscontrol_aresetn => s_axi_pscontrol_aresetn,
      s_axi_pscontrol_arvalid => s_axi_pscontrol_arvalid,
      s_axi_pscontrol_awaddr(1 downto 0) => s_axi_pscontrol_awaddr(1 downto 0),
      s_axi_pscontrol_awvalid => s_axi_pscontrol_awvalid,
      s_axi_pscontrol_bready => s_axi_pscontrol_bready,
      s_axi_pscontrol_bvalid => s_axi_pscontrol_bvalid,
      s_axi_pscontrol_rdata(31 downto 0) => s_axi_pscontrol_rdata(31 downto 0),
      s_axi_pscontrol_rready => s_axi_pscontrol_rready,
      s_axi_pscontrol_rvalid => s_axi_pscontrol_rvalid,
      s_axi_pscontrol_wdata(31 downto 0) => s_axi_pscontrol_wdata(31 downto 0),
      s_axi_pscontrol_wstrb(3 downto 0) => s_axi_pscontrol_wstrb(3 downto 0),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity dma_mac_calculate_design_axis_mac_0_1 is
  port (
    irq : out STD_LOGIC;
    ...
    s_axi_intr_aclk : in STD_LOGIC;
    s_axi_intr_aresetn : in STD_LOGIC;
    m_axis_dataout_tdata : out STD_LOGIC_VECTOR ( 31 downto 0 );
    m_axis_dataout_tstrb : out STD_LOGIC_VECTOR ( 3 downto 0 );
    m_axis_dataout_tlast : out STD_LOGIC;
    m_axis_dataout_tvalid : out STD_LOGIC;
    m_axis_dataout_tready : in STD_LOGIC;
    m_axis_dataout_aclk : in STD_LOGIC;
    m_axis_dataout_aresetn : in STD_LOGIC;
    s_axis_datain_tdata : in STD_LOGIC_VECTOR ( 31 downto 0 );
    s_axis_datain_tstrb : in STD_LOGIC_VECTOR ( 3 downto 0 );
    s_axis_datain_tlast : in STD_LOGIC;
    s_axis_datain_tvalid : in STD_LOGIC;
    s_axis_datain_tready : out STD_LOGIC;
    s_axis_datain_aclk : in STD_LOGIC;
    s_axis_datain_aresetn : in STD_LOGIC;
    s_axi_pscontrol_awaddr : in STD_LOGIC_VECTOR ( 3 downto 0 );
    s_axi_pscontrol_awprot : in STD_LOGIC_VECTOR ( 2 downto 0 );
    s_axi_pscontrol_awvalid : in STD_LOGIC;
    s_axi_pscontrol_awready : out STD_LOGIC;
    s_axi_pscontrol_wdata : in STD_LOGIC_VECTOR ( 31 downto 0 );
    s_axi_pscontrol_wstrb : in STD_LOGIC_VECTOR ( 3 downto 0 );
    s_axi_pscontrol_wvalid : in STD_LOGIC;
    s_axi_pscontrol_wready : out STD_LOGIC;
    s_axi_pscontrol_bresp : out STD_LOGIC_VECTOR ( 1 downto 0 );
    s_axi_pscontrol_bvalid : out STD_LOGIC;
    s_axi_pscontrol_bready : in STD_LOGIC;
    s_axi_pscontrol_araddr : in STD_LOGIC_VECTOR ( 3 downto 0 );
    s_axi_pscontrol_arprot : in STD_LOGIC_VECTOR ( 2 downto 0 );
    s_axi_pscontrol_arvalid : in STD_LOGIC;
    s_axi_pscontrol_arready : out STD_LOGIC;
    s_axi_pscontrol_rdata : out STD_LOGIC_VECTOR ( 31 downto 0 );
    s_axi_pscontrol_rresp : out STD_LOGIC_VECTOR ( 1 downto 0 );
    s_axi_pscontrol_rvalid : out STD_LOGIC;
    s_axi_pscontrol_rready : in STD_LOGIC;
    s_axi_pscontrol_aclk : in STD_LOGIC;
    s_axi_pscontrol_aresetn : in STD_LOGIC
  ...
  attribute NotValidForBitStream of dma_mac_calculate_design_axis_mac_0_1 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of dma_mac_calculate_design_axis_mac_0_1 : entity is "dma_mac_calculate_design_axis_mac_0_1,axis_mac_v1_0,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of dma_mac_calculate_design_axis_mac_0_1 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of dma_mac_calculate_design_axis_mac_0_1 : entity is "axis_mac_v1_0,Vivado 2019.1";
end dma_mac_calculate_design_axis_mac_0_1;

architecture STRUCTURE of dma_mac_calculate_design_axis_mac_0_1 is
  signal \<const0>\ : STD_LOGIC;
  signal \<const1>\ : STD_LOGIC;
  signal \^m_axis_dataout_tdata\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal \^s_axi_intr_rdata\ : STD_LOGIC_VECTOR ( 0 to 0 );
  attribute X_INTERFACE_INFO : string;
  attribute X_INTERFACE_INFO of irq : signal is "xilinx.com:signal:interrupt:1.0 IRQ INTERRUPT";
  attribute X_INTERFACE_PARAMETER : string;
  attribute X_INTERFACE_PARAMETER of irq : signal is "XIL_INTERFACENAME IRQ, SENSITIVITY LEVEL_HIGH, PortWidth 1";
  attribute X_INTERFACE_INFO of m_axis_dataout_aclk : signal is "xilinx.com:signal:clock:1.0 M_AXIS_DataOut_CLK CLK";
  attribute X_INTERFACE_PARAMETER of m_axis_dataout_aclk : signal is "XIL_INTERFACENAME M_AXIS_DataOut_CLK, ASSOCIATED_BUSIF M_AXIS_DataOut, ASSOCIATED_RESET m_axis_dataout_aresetn, FREQ_HZ 100000000, PHASE 0.000, CLK_DOMAIN dma_mac_calculate_design_processing_system7_0_0_FCLK_CLK0, INSERT_VIP 0";
  attribute X_INTERFACE_INFO of m_axis_dataout_aresetn : signal is "xilinx.com:signal:reset:1.0 M_AXIS_DataOut_RST RST";
  attribute X_INTERFACE_PARAMETER of m_axis_dataout_aresetn : signal is "XIL_INTERFACENAME M_AXIS_DataOut_RST, POLARITY ACTIVE_LOW, INSERT_VIP 0";
  attribute X_INTERFACE_INFO of m_axis_dataout_tlast : signal is "xilinx.com:interface:axis:1.0 M_AXIS_DataOut TLAST";
  attribute X_INTERFACE_INFO of m_axis_dataout_tready : signal is "xilinx.com:interface:axis:1.0 M_AXIS_DataOut TREADY";
  attribute X_INTERFACE_PARAMETER of m_axis_dataout_tready : signal is "XIL_INTERFACENAME M_AXIS_DataOut, WIZ_DATA_WIDTH 32, TDATA_NUM_BYTES 4, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0, HAS_TREADY 1, HAS_TSTRB 1, HAS_TKEEP 0, HAS_TLAST 1, FREQ_HZ 100000000, PHASE 0.000, CLK_DOMAIN dma_mac_calculate_design_processing_system7_0_0_FCLK_CLK0, LAYERED_METADATA undef, INSERT_VIP 0";
  attribute X_INTERFACE_INFO of m_axis_dataout_tvalid : signal is "xilinx.com:interface:axis:1.0 M_AXIS_DataOut TVALID";
  attribute X_INTERFACE_INFO of s_axi_intr_aclk : signal is "xilinx.com:signal:clock:1.0 S_AXI_INTR_CLK CLK";
  attribute X_INTERFACE_PARAMETER of s_axi_intr_aclk : signal is "XIL_INTERFACENAME S_AXI_INTR_CLK, ASSOCIATED_BUSIF S_AXI_INTR, ASSOCIATED_RESET s_axi_intr_aresetn, FREQ_HZ 100000000, PHASE 0.000, CLK_DOMAIN dma_mac_calculate_design_processing_system7_0_0_FCLK_CLK0, INSERT_VIP 0";
  ...
  attribute X_INTERFACE_PARAMETER of s_axi_intr_rready : signal is "XIL_INTERFACENAME S_AXI_INTR, WIZ_DATA_WIDTH 32, WIZ_NUM_REG 5, SUPPORTS_NARROW_BURST 0, DATA_WIDTH 32, PROTOCOL AXI4LITE, FREQ_HZ 100000000, ID_WIDTH 0, ADDR_WIDTH 5, AWUSER_WIDTH 0, ARUSER_WIDTH 0, WUSER_WIDTH 0, RUSER_WIDTH 0, BUSER_WIDTH 0, READ_WRITE_MODE READ_WRITE, HAS_BURST 0, HAS_LOCK 0, HAS_PROT 1, HAS_CACHE 0, HAS_QOS 0, HAS_REGION 0, HAS_WSTRB 1, HAS_BRESP 1, HAS_RRESP 1, NUM_READ_OUTSTANDING 2, NUM_WRITE_OUTSTANDING 2, MAX_BURST_LENGTH 1, PHASE 0.000, CLK_DOMAIN dma_mac_calculate_design_processing_system7_0_0_FCLK_CLK0, NUM_READ_THREADS 1, NUM_WRITE_THREADS 1, RUSER_BITS_PER_BYTE 0, WUSER_BITS_PER_BYTE 0, INSERT_VIP 0";
  ...
  attribute X_INTERFACE_INFO of s_axi_pscontrol_aclk : signal is "xilinx.com:signal:clock:1.0 S_AXI_PsControl_CLK CLK";
  attribute X_INTERFACE_PARAMETER of s_axi_pscontrol_aclk : signal is "XIL_INTERFACENAME S_AXI_PsControl_CLK, ASSOCIATED_BUSIF S_AXI_PsControl, ASSOCIATED_RESET s_axi_pscontrol_aresetn, FREQ_HZ 100000000, PHASE 0.000, CLK_DOMAIN dma_mac_calculate_design_processing_system7_0_0_FCLK_CLK0, INSERT_VIP 0";
  attribute X_INTERFACE_INFO of s_axi_pscontrol_aresetn : signal is "xilinx.com:signal:reset:1.0 S_AXI_PsControl_RST RST";
  attribute X_INTERFACE_PARAMETER of s_axi_pscontrol_aresetn : signal is "XIL_INTERFACENAME S_AXI_PsControl_RST, POLARITY ACTIVE_LOW, INSERT_VIP 0";
  attribute X_INTERFACE_INFO of s_axi_pscontrol_arready : signal is "xilinx.com:interface:aximm:1.0 S_AXI_PsControl ARREADY";
  attribute X_INTERFACE_INFO of s_axi_pscontrol_arvalid : signal is "xilinx.com:interface:aximm:1.0 S_AXI_PsControl ARVALID";
  attribute X_INTERFACE_INFO of s_axi_pscontrol_awready : signal is "xilinx.com:interface:aximm:1.0 S_AXI_PsControl AWREADY";
  attribute X_INTERFACE_INFO of s_axi_pscontrol_awvalid : signal is "xilinx.com:interface:aximm:1.0 S_AXI_PsControl AWVALID";
  attribute X_INTERFACE_INFO of s_axi_pscontrol_bready : signal is "xilinx.com:interface:aximm:1.0 S_AXI_PsControl BREADY";
  attribute X_INTERFACE_INFO of s_axi_pscontrol_bvalid : signal is "xilinx.com:interface:aximm:1.0 S_AXI_PsControl BVALID";
  attribute X_INTERFACE_INFO of s_axi_pscontrol_rready : signal is "xilinx.com:interface:aximm:1.0 S_AXI_PsControl RREADY";
  attribute X_INTERFACE_PARAMETER of s_axi_pscontrol_rready : signal is "XIL_INTERFACENAME S_AXI_PsControl, WIZ_DATA_WIDTH 32, WIZ_NUM_REG 4, SUPPORTS_NARROW_BURST 0, DATA_WIDTH 32, PROTOCOL AXI4LITE, FREQ_HZ 100000000, ID_WIDTH 0, ADDR_WIDTH 4, AWUSER_WIDTH 0, ARUSER_WIDTH 0, WUSER_WIDTH 0, RUSER_WIDTH 0, BUSER_WIDTH 0, READ_WRITE_MODE READ_WRITE, HAS_BURST 0, HAS_LOCK 0, HAS_PROT 1, HAS_CACHE 0, HAS_QOS 0, HAS_REGION 0, HAS_WSTRB 1, HAS_BRESP 1, HAS_RRESP 1, NUM_READ_OUTSTANDING 2, NUM_WRITE_OUTSTANDING 2, MAX_BURST_LENGTH 1, PHASE 0.000, CLK_DOMAIN dma_mac_calculate_design_processing_system7_0_0_FCLK_CLK0, NUM_READ_THREADS 1, NUM_WRITE_THREADS 1, RUSER_BITS_PER_BYTE 0, WUSER_BITS_PER_BYTE 0, INSERT_VIP 0";
  attribute X_INTERFACE_INFO of s_axi_pscontrol_rvalid : signal is "xilinx.com:interface:aximm:1.0 S_AXI_PsControl RVALID";
  attribute X_INTERFACE_INFO of s_axi_pscontrol_wready : signal is "xilinx.com:interface:aximm:1.0 S_AXI_PsControl WREADY";
  attribute X_INTERFACE_INFO of s_axi_pscontrol_wvalid : signal is "xilinx.com:interface:aximm:1.0 S_AXI_PsControl WVALID";
  attribute X_INTERFACE_INFO of s_axis_datain_aclk : signal is "xilinx.com:signal:clock:1.0 S_AXIS_DataIn_CLK CLK";
  attribute X_INTERFACE_PARAMETER of s_axis_datain_aclk : signal is "XIL_INTERFACENAME S_AXIS_DataIn_CLK, ASSOCIATED_BUSIF S_AXIS_DataIn, ASSOCIATED_RESET s_axis_datain_aresetn, FREQ_HZ 100000000, PHASE 0.000, CLK_DOMAIN dma_mac_calculate_design_processing_system7_0_0_FCLK_CLK0, INSERT_VIP 0";
  attribute X_INTERFACE_INFO of s_axis_datain_aresetn : signal is "xilinx.com:signal:reset:1.0 S_AXIS_DataIn_RST RST";
  attribute X_INTERFACE_PARAMETER of s_axis_datain_aresetn : signal is "XIL_INTERFACENAME S_AXIS_DataIn_RST, POLARITY ACTIVE_LOW, INSERT_VIP 0";
  attribute X_INTERFACE_INFO of s_axis_datain_tlast : signal is "xilinx.com:interface:axis:1.0 S_AXIS_DataIn TLAST";
  attribute X_INTERFACE_INFO of s_axis_datain_tready : signal is "xilinx.com:interface:axis:1.0 S_AXIS_DataIn TREADY";
  attribute X_INTERFACE_PARAMETER of s_axis_datain_tready : signal is "XIL_INTERFACENAME S_AXIS_DataIn, WIZ_DATA_WIDTH 32, TDATA_NUM_BYTES 4, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0, HAS_TREADY 1, HAS_TSTRB 1, HAS_TKEEP 0, HAS_TLAST 1, FREQ_HZ 100000000, PHASE 0.000, CLK_DOMAIN dma_mac_calculate_design_processing_system7_0_0_FCLK_CLK0, LAYERED_METADATA undef, INSERT_VIP 0";
  attribute X_INTERFACE_INFO of s_axis_datain_tvalid : signal is "xilinx.com:interface:axis:1.0 S_AXIS_DataIn TVALID";
  attribute X_INTERFACE_INFO of m_axis_dataout_tdata : signal is "xilinx.com:interface:axis:1.0 M_AXIS_DataOut TDATA";
  attribute X_INTERFACE_INFO of m_axis_dataout_tstrb : signal is "xilinx.com:interface:axis:1.0 M_AXIS_DataOut TSTRB";
  ...
  attribute X_INTERFACE_INFO of s_axi_pscontrol_araddr : signal is "xilinx.com:interface:aximm:1.0 S_AXI_PsControl ARADDR";
  attribute X_INTERFACE_INFO of s_axi_pscontrol_arprot : signal is "xilinx.com:interface:aximm:1.0 S_AXI_PsControl ARPROT";
  attribute X_INTERFACE_INFO of s_axi_pscontrol_awaddr : signal is "xilinx.com:interface:aximm:1.0 S_AXI_PsControl AWADDR";
  attribute X_INTERFACE_INFO of s_axi_pscontrol_awprot : signal is "xilinx.com:interface:aximm:1.0 S_AXI_PsControl AWPROT";
  attribute X_INTERFACE_INFO of s_axi_pscontrol_bresp : signal is "xilinx.com:interface:aximm:1.0 S_AXI_PsControl BRESP";
  attribute X_INTERFACE_INFO of s_axi_pscontrol_rdata : signal is "xilinx.com:interface:aximm:1.0 S_AXI_PsControl RDATA";
  attribute X_INTERFACE_INFO of s_axi_pscontrol_rresp : signal is "xilinx.com:interface:aximm:1.0 S_AXI_PsControl RRESP";
  attribute X_INTERFACE_INFO of s_axi_pscontrol_wdata : signal is "xilinx.com:interface:aximm:1.0 S_AXI_PsControl WDATA";
  attribute X_INTERFACE_INFO of s_axi_pscontrol_wstrb : signal is "xilinx.com:interface:aximm:1.0 S_AXI_PsControl WSTRB";
  attribute X_INTERFACE_INFO of s_axis_datain_tdata : signal is "xilinx.com:interface:axis:1.0 S_AXIS_DataIn TDATA";
  attribute X_INTERFACE_INFO of s_axis_datain_tstrb : signal is "xilinx.com:interface:axis:1.0 S_AXIS_DataIn TSTRB";
begin
  m_axis_dataout_tdata(31) <= \<const0>\;
  m_axis_dataout_tdata(30) <= \<const0>\;
  m_axis_dataout_tdata(29) <= \<const0>\;
  m_axis_dataout_tdata(28) <= \<const0>\;
  m_axis_dataout_tdata(27) <= \<const0>\;
  m_axis_dataout_tdata(26) <= \<const0>\;
  m_axis_dataout_tdata(25) <= \<const0>\;
  m_axis_dataout_tdata(24) <= \<const0>\;
  m_axis_dataout_tdata(23) <= \<const0>\;
  m_axis_dataout_tdata(22) <= \<const0>\;
  m_axis_dataout_tdata(21) <= \<const0>\;
  m_axis_dataout_tdata(20) <= \<const0>\;
  m_axis_dataout_tdata(19) <= \<const0>\;
  m_axis_dataout_tdata(18) <= \<const0>\;
  m_axis_dataout_tdata(17) <= \<const0>\;
  m_axis_dataout_tdata(16) <= \<const0>\;
  m_axis_dataout_tdata(15) <= \<const0>\;
  m_axis_dataout_tdata(14) <= \<const0>\;
  m_axis_dataout_tdata(13) <= \<const0>\;
  m_axis_dataout_tdata(12) <= \<const0>\;
  m_axis_dataout_tdata(11) <= \<const0>\;
  m_axis_dataout_tdata(10) <= \<const0>\;
  m_axis_dataout_tdata(9) <= \<const0>\;
  m_axis_dataout_tdata(8) <= \<const0>\;
  m_axis_dataout_tdata(7) <= \<const0>\;
  m_axis_dataout_tdata(6) <= \<const0>\;
  m_axis_dataout_tdata(5) <= \<const0>\;
  m_axis_dataout_tdata(4) <= \<const0>\;
  m_axis_dataout_tdata(3 downto 0) <= \^m_axis_dataout_tdata\(3 downto 0);
  m_axis_dataout_tstrb(3) <= \<const1>\;
  m_axis_dataout_tstrb(2) <= \<const1>\;
  m_axis_dataout_tstrb(1) <= \<const1>\;
  m_axis_dataout_tstrb(0) <= \<const1>\;
  ...
  s_axi_pscontrol_bresp(1) <= \<const0>\;
  s_axi_pscontrol_bresp(0) <= \<const0>\;
  s_axi_pscontrol_rresp(1) <= \<const0>\;
  s_axi_pscontrol_rresp(0) <= \<const0>\;
...
inst: entity work.dma_mac_calculate_design_axis_mac_0_1_axis_mac_v1_0
     port map (
      irq => irq,
      m_axis_dataout_aclk => m_axis_dataout_aclk,
      m_axis_dataout_aresetn => m_axis_dataout_aresetn,
      ...
      s_axi_intr_wvalid => s_axi_intr_wvalid,
      s_axi_pscontrol_aclk => s_axi_pscontrol_aclk,
      s_axi_pscontrol_araddr(1 downto 0) => s_axi_pscontrol_araddr(3 downto 2),
      s_axi_pscontrol_aresetn => s_axi_pscontrol_aresetn,
      s_axi_pscontrol_arready => s_axi_pscontrol_arready,
      s_axi_pscontrol_arvalid => s_axi_pscontrol_arvalid,
      s_axi_pscontrol_awaddr(1 downto 0) => s_axi_pscontrol_awaddr(3 downto 2),
