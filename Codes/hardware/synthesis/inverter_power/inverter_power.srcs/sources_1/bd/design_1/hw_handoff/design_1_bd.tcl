...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net in_0_1 [get_bd_ports in_0] [get_bd_pins inverter_0/inp]
  connect_bd_net -net inverter_0_out [get_bd_ports out_0] [get_bd_pins inverter_0/outp]
