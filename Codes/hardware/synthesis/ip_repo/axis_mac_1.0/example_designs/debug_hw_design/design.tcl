...
proc create_ipi_design { offsetfile design_name } {
	...
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins axis_mac_0/S_AXIS_DataIn]
	...
	# Connect all clock, reset & status pins of axis_mac_0 master interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_mem_interconnect/S00_AXI] [get_bd_intf_pins axis_mac_0/M_AXIS_DataOut]
	...
	connect_bd_net [get_bd_pins axis_mac_0/m_axis_dataout_txn_done] [get_bd_pins xlconcat_0/In0]
	connect_bd_net [get_bd_pins axis_mac_0/m_axis_dataout_error] [get_bd_pins xlconcat_0/In1]
	connect_bd_net [get_bd_pins axis_mac_0/m_axis_dataout_init_axi_txn] [ get_bd_pins axi_gpio_out/gpio_io_o ]


	# Auto assign address
	assign_bd_address

	# Configure address param & range of axis_mac_0 master interfaces..
	set_property range 16K [get_bd_addr_segs {jtag_axi_0/Data/SEG_axi_bram_ctrl_0_Mem0}]
	set_property range 16K [get_bd_addr_segs {axis_mac_0/M_AXIS_DataOut/SEG_axi_bram_ctrl_0_Mem0}]
	set_property -dict [list  CONFIG.C_M_AXIS_DataOut_TARGET_SLAVE_BASE_ADDR {0xC0000000} ] [get_bd_cells axis_mac_0]
	...
	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_axis_mac_0_S_AXIS_DataIn_* ]]
	puts $fp "set s_axis_datain_addr ${offset}"
