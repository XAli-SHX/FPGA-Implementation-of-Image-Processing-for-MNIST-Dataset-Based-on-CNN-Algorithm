...
# Test: S_AXI_PsControl
# Create a write transaction at s_axi_pscontrol_addr address
create_hw_axi_txn w_s_axi_pscontrol_addr [get_hw_axis $jtag_axi_master] -type write -address $s_axi_pscontrol_addr -data $wdata_1
# Create a read transaction at s_axi_pscontrol_addr address
create_hw_axi_txn r_s_axi_pscontrol_addr [get_hw_axis $jtag_axi_master] -type read -address $s_axi_pscontrol_addr
# Initiate transactions
run_hw_axi r_s_axi_pscontrol_addr
run_hw_axi w_s_axi_pscontrol_addr
run_hw_axi r_s_axi_pscontrol_addr
set rdata_tmp [get_property DATA [get_hw_axi_txn r_s_axi_pscontrol_addr]]
# Compare read data
if { $rdata_tmp == $wdata_1 } {
	puts "Data comparison test pass for - S_AXI_PsControl"
} else {
	puts "Data comparison test fail for - S_AXI_PsControl, expected-$wdata_1 actual-$rdata_tmp"
	inc ec
}
