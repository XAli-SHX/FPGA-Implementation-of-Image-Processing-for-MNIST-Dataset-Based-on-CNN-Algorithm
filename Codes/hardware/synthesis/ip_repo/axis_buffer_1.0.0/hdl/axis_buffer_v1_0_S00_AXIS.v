...
`timescale 1 ns / 1 ps
	...
	module axis_buffer_v1_0_S00_AXIS #
	(
	...
	(
		...
		output [31:0] stream_data_fifo_DATA,
		input [4:0] stream_data_fifo_PTR
	);
	...
	assign stream_data_fifo_DATA = stream_data_fifo[stream_data_fifo_PTR];
