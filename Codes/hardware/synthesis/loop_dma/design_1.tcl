...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net axis_buffer_0_ex_startAck [get_bd_pins axis_buffer_0/ex_startAck] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net my_zero_0_zero_out [get_bd_pins my_zero_0/zero_out] [get_bd_pins xlconcat_0/In1]
