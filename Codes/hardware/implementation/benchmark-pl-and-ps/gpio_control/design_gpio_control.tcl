...
################################################################
# This is a generated script based on design: design_gpio_control
#
...
# source design_gpio_control_script.tcl
...
set design_name design_gpio_control
...
proc create_root_design { parentCell } {
  ...
  # Create instance: jc2_0, and set properties
  set block_name jc2
  set block_cell_name jc2_0
  if { [catch {set jc2_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $jc2_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  # Create instance: left, and set properties
  set left [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 left ]
  ...
  # Create instance: right, and set properties
  set right [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 right ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {1} \
   CONFIG.DIN_TO {1} \
   CONFIG.DIN_WIDTH {64} \
  ...
  # Create instance: stop, and set properties
  set stop [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 stop ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {2} \
   CONFIG.DIN_TO {2} \
   CONFIG.DIN_WIDTH {64} \
  ...
  connect_bd_net -net Clock_Divider_0_clock_out [get_bd_pins Clock_Divider_0/clock_out] [get_bd_pins jc2_0/clk]
  connect_bd_net -net jc2_0_q [get_bd_ports leds] [get_bd_pins jc2_0/q]
  connect_bd_net -net left_Dout [get_bd_pins jc2_0/goLeft] [get_bd_pins left/Dout]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins Clock_Divider_0/clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins Clock_Divider_0/reset] [get_bd_pins processing_system7_0/FCLK_RESET0_N]
  connect_bd_net -net processing_system7_0_GPIO_O [get_bd_pins left/Din] [get_bd_pins processing_system7_0/GPIO_O] [get_bd_pins right/Din] [get_bd_pins stop/Din]
  connect_bd_net -net right_Dout [get_bd_pins jc2_0/goRight] [get_bd_pins right/Dout]
  connect_bd_net -net stop_Dout [get_bd_pins jc2_0/stop] [get_bd_pins stop/Dout]
