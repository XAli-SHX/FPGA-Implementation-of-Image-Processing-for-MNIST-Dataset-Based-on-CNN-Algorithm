...
xilinx.com:user:axis_buffer:1.0\
...
proc create_root_design { parentCell } {
  ...
  set axis_buffer_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:axis_buffer:1.0 axis_buffer_0 ]

  # Create instance: my_zero_0, and set properties
  set block_name my_zero
  set block_cell_name my_zero_0
  if { [catch {set my_zero_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
  ...
  # Create instance: my_zero_1, and set properties
  set block_name my_zero
  set block_cell_name my_zero_1
  if { [catch {set my_zero_1 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $my_zero_1 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  # Create instance: xlslice_start, and set properties
  set xlslice_start [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 xlslice_start ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {0} \
   CONFIG.DIN_TO {0} \
   CONFIG.DIN_WIDTH {64} \
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins axis_buffer_0/S00_AXIS]
  ...
  connect_bd_intf_net -intf_net axis_buffer_0_M00_AXIS [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins axis_buffer_0/M00_AXIS]
  ...
  connect_bd_net -net axis_buffer_0_ex_startAck [get_bd_pins axis_buffer_0/ex_startAck] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net my_zero_0_zero_out [get_bd_pins my_zero_0/zero_out] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net my_zero_1_zero_out [get_bd_pins my_zero_1/zero_out] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins axi_smc_1/aclk] [get_bd_pins axis_buffer_0/clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP2_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net processing_system7_0_GPIO_O [get_bd_pins processing_system7_0/GPIO_O] [get_bd_pins xlslice_start/Din]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axi_smc_1/aresetn] [get_bd_pins axis_buffer_0/rst_n] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins processing_system7_0/GPIO_I] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net xlslice_start_Dout [get_bd_pins axis_buffer_0/ex_start] [get_bd_pins xlslice_start/Dout]
