...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
xilinx.com:user:GpAxisInterface:1.0\
...
proc create_root_design { parentCell } {
  ...
  set block_cell_name adder5_0
  if { [catch {set adder5_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
