...
proc create_root_design { parentCell } {
  ...
  set axis_fifo_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:axis_fifo:1.0 axis_fifo_0 ]
  set_property -dict [ list \
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins axis_fifo_0/s_axis]
  ...
  connect_bd_intf_net -intf_net axis_fifo_0_m_axis [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins axis_fifo_0/m_axis]
